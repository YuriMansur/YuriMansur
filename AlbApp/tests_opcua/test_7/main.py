...
class OpcUaScanner(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Горизонтальный сплиттер: дерево+лог слева, панель параметров справа
        splitter_main = QSplitter(Qt.Orientation.Horizontal)

        # Левый вертикальный сплиттер: дерево и лог
        ...
        # Правая панель: информация о выбранном узле
        ...
        info_layout.addRow("Value:", self.lbl_value)
    ...
    def show_tag_info(self):
        ...
        self.lbl_value.setText(str(data.get("value", "")))
